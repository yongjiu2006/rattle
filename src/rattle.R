...
#
# Time-stamp: <2011-02-13 21:40:37 Graham Williams>
#
...
REVISION <- "3" # Started 110113
VERSION <- paste(MAJOR, MINOR, REVISION, sep=".")
VERSION.DATE <- "Released 13 Jan 2011"
...
rattle <- function(csvname=NULL, useGtkBuilder)
{
  ...
  if (crv$useGtkBuilder)
  {
    rattleGUI <<- gtkBuilderNew()
    rattleGUI$setTranslationDomain("R-rattle")
  }
